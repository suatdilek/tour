    ...
    <div class="tp-banner">
        <ul>
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                <!-- MAIN IMAGE -->
                <img src="<?php echo public_url('img/slides_bg/dummy.png');?>" alt="slidebg1" data-lazyload="<?php echo public_url('haber/1800x700/s1.jpg');?>" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYER NR. 1 -->
                <div class="tp-caption white_heavy_40 customin customout text-center text-uppercase"
                     ...
                     data-speed="1000" data-start="1700" data-easing="Back.easeInOut" data-endspeed="300" style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Affordable Paris Tours
                </div>
                <!-- LAYER NR. 2 -->
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                <!-- MAIN IMAGE -->
                <img src="<?php echo public_url('img/slides_bg/dummy.png');?>" alt="slidebg1" data-lazyload="<?php echo public_url('haber/1800x700/s2.jpg');?>" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYER NR. 1 -->
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                <!-- MAIN IMAGE -->
                <img src="<?php echo public_url('img/slides_bg/dummy.png');?>" alt="slidebg1" data-lazyload="<?php echo public_url('haber/1800x700/s3.jpg');?>" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYER NR. 1 -->
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                <!-- MAIN IMAGE -->
                <img src="<?php echo public_url('img/slides_bg/dummy.png');?>" alt="slidebg1" data-lazyload="<?php echo public_url('haber/1800x700/s4.jpg');?>" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYER NR. 1 -->
