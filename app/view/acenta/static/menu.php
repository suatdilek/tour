...
<header id="plain">
    <div id="top_line">
        <div class="container">
            <div class="row">
                <div class="col-6"><i class="icon-phone"></i><strong>+90 232 555 55 55</strong></div>
                <div class="col-6">
                    <ul id="top_links">
        ...
        <div class="row">
            ...
            <nav class="col-9">
                ...
                <div class="main-menu">
                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="show-submenu">Anasayfa <i class="icon-down-open-mini"></i></a>
                            <ul>
