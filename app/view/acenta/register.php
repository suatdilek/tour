        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                    <div id="login">
                        <div class="text-center"><h3>Kayıt Formu</h3></div>
                        <hr>
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_again" class=" form-control" id="password2" placeholder="Şifre (Tekrar)">
                            </div>
                            <div id="pass-info" class="clearfix"></div>
                            <input type="hidden" name="submit" value="1">
                            <button type="submit" class="btn_full">Kayıt Ol</button>
                        </form>
                    </div>
                </div>
            </div>
